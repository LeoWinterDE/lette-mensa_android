...
public class SpeisenItem extends LinearLayout {
    ...
    public SpeisenItem(Context context, final Speise speise, String drawable) {
        ...
        icon.setImageDrawable(getResources().getDrawable(R.drawable.ic_lettelogo));
        ...
        like1 = getResources().getDrawable(R.drawable.ic_like1);
        like2 = getResources().getDrawable(R.drawable.ic_like2);
        likeButton.setImageDrawable(like2);
            ...
            public void onClick(View v) {
                if (selectedButton == v) {
                    new Thread() {
                        public void run() {
                            try {
                                // TODO: Speise to Termin (speise.getTermin.getId())
        ...
        dislike1 = (getResources().getDrawable(R.drawable.ic_dislike1));
        dislike2 = (getResources().getDrawable(R.drawable.ic_dislike2));
